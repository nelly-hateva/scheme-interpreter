...
describe SchemeParser , "primitive operators with two arguments" do
...
describe SchemeParser , "primitive operators with three or more arguments" do
  ...
  #it 'can parse multiplication' do
    #@parser.parse("(* 2 3 4)").to_sexp.should eq ??
  #end
end

describe SchemeParser , "nested primitive expressions" do
